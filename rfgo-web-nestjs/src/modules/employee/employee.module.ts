...
import { EmployeeResolver } from './interface/employee.resolver';
import { EmployeeProvider } from '../../common/interfaces/employee-provider.interface';
import { KnoxEmployeeProvider } from '../../infrastructure/employee/knox-employee.provider';
import { DevEmployeeProvider } from '../../infrastructure/employee/dev-employee.provider';
