...
export const TableCompareSelector: React.FC = () => {
  ...
  return (
    <div className="h-full w-full flex flex-col min-w-0 p-6 overflow-hidden">
      <header className="flex flex-col gap-1 shrink-0 mb-6">
      ...
      <div className="flex-1 flex flex-col lg:flex-row gap-6 min-h-0">
        ...
        <div className="w-full lg:w-1/3 bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-xl flex flex-col overflow-hidden shadow-sm min-h-0 shrink-0">
          <div className="p-4 border-b border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/50 shrink-0 flex justify-between items-center">
            ...
            <div className="ml-3 px-2 py-1 bg-slate-100 dark:bg-slate-800 rounded text-[9px] font-black text-slate-500 uppercase tracking-tighter shrink-0">
              Total: {totalTableCount}
            </div>
          </div>
          
          <div className="flex-1 overflow-y-auto custom-scrollbar p-2 min-h-0">
            {loadingNames && tableNames.length === 0 ? (
              ...
              <div className="space-y-1">
                ...
                {hasMore && (
                  <button
                    ...
                    className="w-full py-3 mt-2 text-[10px] font-black text-indigo-600 dark:text-indigo-400 uppercase tracking-widest hover:bg-indigo-50 dark:hover:bg-indigo-500/10 rounded-lg transition-colors flex items-center justify-center gap-2"
                  >
                    {loadingNames ? (
        ...
        <div className="flex-1 bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-xl flex flex-col overflow-hidden shadow-sm min-h-0">
